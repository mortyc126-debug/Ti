...
def analyze_news(title: str, summary: str, ticker: str) -> dict:
    ...
    prompt = f"""Задача — техническая классификация тональности новостного
заголовка для тикера {ticker}. Это не инвестиционный совет и не обсуждение
темы, а разметка текста. Всегда возвращай только JSON, даже если тема
чувствительная — при сомнении ставь "neutral".
