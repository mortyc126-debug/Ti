...
const _METHOD_CATALOG = [
  ...
  ["Открытый интерес (FutOI) — провайдер","OI_SQUEEZE","сквиз открытого интереса",1],
  ["Открытый интерес (FutOI) — провайдер","INST_OI","нетто-позиция юрлиц",1],
  ["Открытый интерес (FutOI) — провайдер","RETAIL_CONTRA","контр-сигнал физлиц",1],
  ["Открытый интерес (FutOI) — провайдер","DELTA_QUADRANT","квадрант дельты ОИ",1],
  ["Открытый интерес (FutOI) — провайдер","OI_ABSORPTION","поглощение по ОИ",1],
