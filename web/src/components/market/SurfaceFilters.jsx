...
const BOND_MULT_OPTIONS  = ['safety','bqi','icr','nde','de','roa','roic','roe','ebitdaMarg','currentR','equityR','cashR'];
const STOCK_MULT_OPTIONS = ['safety','bqi','pe','roa','roic','roe','icr','nde','ebitdaMarg','currentR','equityR'];
