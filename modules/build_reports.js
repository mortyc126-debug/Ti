...
:root{
  ...
  --t3:#6F648F;
  --t4:#7E74A8;
  --glow:0 0 0 1px rgba(170,90,255,0.08),0 0 18px rgba(170,90,255,0.06),inset 0 0 20px rgba(255,255,255,0.01);
...
.btn-p,.btn-primary,.btn-acc{border-color:rgba(167,139,250,.4);color:var(--acc);background:rgba(167,139,250,.08)}
.btn-p:hover,.btn-primary:hover,.btn-acc:hover{background:rgba(167,139,250,.15)}
...
input:focus,select:focus{border-color:rgba(167,139,250,.5);box-shadow:none}
...
/* Issuer header */
.iss-hdr{padding:16px 20px 14px;border-bottom:1px solid rgba(170,90,255,0.18);
...
.ptab.active .p-badge{background:rgba(167,139,250,.09);color:var(--acc);border-color:rgba(167,139,250,.22)}
